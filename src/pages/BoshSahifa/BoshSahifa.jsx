...
import { shoppingAdd, homemodal, cardLike, cardDel, cardAdd, madalAdd, madalDel, } from "./ProductData"
                                                                            ...
                                                                            <div className="mt-3">
                                                                                ...
                                                                                <div className="d-flex mt-3 align-items-center">
                                                                                    <div className="count_content d-flex">
                                                                                        <button onClick={() => dispetch(madalDel(item.id))} className='Btn_increment align-items-center me-4'><img src={MinusBtn} alt="minus" /></button>
                                                                                        <h3 className='counst m-0 '>{item.count}</h3>
                                                                                        <button onClick={() => dispetch(madalAdd(item.id))} className='Btn_decrement align-items-center ms-4'><img src={PlusBtn} alt="plus" /></button>
                                                                                    </div>
